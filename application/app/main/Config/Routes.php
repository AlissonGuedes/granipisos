...
$routes -> add('/servicos', 'Servicos::index');
$routes -> add('/servicos/(:any)', 'Servicos::categorias/$1/$2');
$routes -> post('/servicos', 'Servicos::insert');

$routes -> add('/quemsomos', 'Quemsomos::index');

$routes -> add('/clientes', 'Clientes::index');
$routes -> post('/clientes', 'Clientes::insert');
