...
namespace App\Models {
	...
	class ClienteModel extends AppModel {
		...
		public function getAll($find = null) {
			...
			$this -> select('tb_cliente.id, tb_cliente.site, tb_cliente.nome, tb_cliente.rua, tb_cliente.bairro, tb_cliente.cidade, tb_cliente.uf, tb_cliente.imagem, tb_cliente.status');
