...
namespace App\Models {
	...
	class DistribuidorModel extends AppModel {
		...
		public function getAll($find = null) {
			...
			$this -> select('tb_distribuidor.id, tb_distribuidor.nome, tb_distribuidor.rua, tb_distribuidor.bairro, tb_distribuidor.cidade, tb_distribuidor.uf, email, telefone, tb_distribuidor.status');
